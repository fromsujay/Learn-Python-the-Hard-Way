...
class Scene(object):
    ...
    def enter(self):
        print """Aliens have invaded a space ship and our hero has to go through a maze of 
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print "sldj dsflk lksd ksqj slkd sjds, qjsh sjdf sjjls ksjnvjsd."
